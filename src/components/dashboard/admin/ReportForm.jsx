        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <label>
            ...
            <select
              ...
              className="mt-1 block w-full px-3 py-2 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            >
              <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" value="">Select match</option>
              {matches.map((m) => (
                <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" key={m._id} value={m._id}>
          ...
          <label>
            ...
            <select
              ...
              className="mt-1 block w-full px-3 py-2 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            >
              <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" value="">Select winner</option>
              {teams.map((t) => (
          ...
          <label>
            ...
            >
              ...
              <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" value="runs">Runs</option>
              <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" value="wickets">Wickets</option>
              <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" value="superover">Super Over</option>
            </select>
          </label>
          ...
          <label className="md:col-span-2">
            ...
            <select
              ...
              className="mt-1 block w-full px-3 py-2 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
            >
              <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" value="">Select player</option>
              {players.map((p) => (
                <option className="bg-white dark:bg-gray-700 text-gray-900 dark:text-white" key={p._id} value={p._id}>
                  {p.name}
                </option>
              ))}
            </select>
